---
description: Check whether the Gemini CLI is installed and authenticated
argument-hint: ''
...
- If Gemini is installed but not authenticated, preserve the guidance to run `! gemini` interactively to set up credentials.
